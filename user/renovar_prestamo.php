...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id_prestamo'])) {
    ...
    $sql = "SELECT renovaciones, fecha_devolucion FROM prestamos WHERE id_prestamo = '$id_prestamo' AND id_usuario = '" . $_SESSION['id_usuario'] . "' AND estado_prestamo = 'Activo'";
    ...
    if ($result->num_rows == 0) {
        ...
        if ($prestamo['renovaciones'] < 3) {
            ...
            $sql = "UPDATE prestamos 
                    ...
                    WHERE id_prestamo = '$id_prestamo' AND estado_prestamo = 'Activo'";
...
<body>
    ...
    <form method="post" action="renovar_prestamo.php">
